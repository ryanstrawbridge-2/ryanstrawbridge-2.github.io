...
% if the bullets sit too far below the role line.
...
{\small
\textbf{Coursework:}
Mechanical Design, Heat Transfer, Fluid Mechanics, Solid Mechanics,
...
\resumeItemListStart
  ...
  \resumeItem{
  Designed and validated a 2,100 lb hand-portable lifting frame to BTH-1 and
  ASME B30.20, earning sign-off from structural engineering and safety;
  increased table space for fixture tooling during magnet stacking and saved
  30--45 minutes per lift}
  ...
  line; applied GD\&T with position and symmetry controls on dowel-pin datums
  for repeatable alignment, reducing future operation time by over 80\%}
  ...
  wrapping, improving process robustness and reducing labor by 0.5--3 hours
  per magnet layer}
...
\resumeItemListStart
  ...
  time by 75\% and reducing injury risk; still in use over a year later,
  ...
  eliminating trial-and-error die design and enabling future cable-bending
...
\resumeItemListStart
  ...
  adjacent components, increasing first-pass yield and removing filter damage
  as a scrap driver on the line}

  \resumeItem{
  Ran a nine-configuration solder stencil study varying placement and volume
  to provide off-gas escape channels, reducing voiding and removing a rework
  step from the process}

  \resumeItem{
  Co-owned a work cell and developed thermal reflow profiles by refining oven
  parameters through thermocouple data, operator input, and X-ray inspection
  to IPC-J-STD-001 Class 3, reducing rework time across 15 programs}
...
\resumeItemListStart
  ...
  \resumeItem{
  Own the mechanical design of a low-cost underwater acoustic release
  ...
  \resumeItem{
  Performed structural analysis of the release shaft under combined axial
  ...
  components in Ansys FEA under combined pressure and mechanical loading}
...
\resumeItemListStart
  ...
  \resumeItem{
  Supported setup and execution of three successful static-fire tests,
...
{\small
\textbf{Software:}
Siemens NX, SolidWorks, Ansys Mechanical, Arduino, Teamcenter, ManufacturO,
Odoo, Confluence, Jira \\[3pt]
\textbf{Design:}
Structural Analysis, DFM, GD\&T, FEA (Ansys -- developing) \\[3pt]
\textbf{Fabrication:}
Manual G-Code Programming, CNC Milling, Power Tools, TIG Welding,
3D Printing, Soldering, Water Jetting, Laser Cutting
}
